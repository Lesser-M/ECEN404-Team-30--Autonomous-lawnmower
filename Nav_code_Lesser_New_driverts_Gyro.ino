...
{ 
  ...
  while(!Correct) 
  {
    heading_L = heading_F; 
    Read_GPS();
    if ((heading_L < heading_F)& (abs(heading_L - heading_F) > 3))
    ...
    else if ((heading_F < heading_L)& (abs(heading_L - heading_F) > 3))
    { // need to turn slighlt left 
      while(L_A_GLOB < 4)
      {
        Left_F(50); 
    ...
    else if(abs(heading_L - heading_F) <3)
    { 
      Correct = true; 
...
{ 
  ...
  while(!Correct) 
  {
    ...
    else if ((heading_F < heading_L)& (abs(heading_L - heading_F) > 3.0))
    { // need to turn slighlt left 
      while(L_A_GLOB < 4)
      {
        //delay(1000); 
