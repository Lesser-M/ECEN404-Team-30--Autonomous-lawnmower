...
Serial.print("hello world");
    ...
    //Setup motor driver logic for PWM
    ...
    ledcWrite(1,100);//( L_Channel, 65);  // Arduino does NOT support analogWrite()

    ledcWrite(2,100);//( L_Channel, 65);  // Arduino does NOT support analogWrite()
...
*/
        ...
        //Turn off right motor so mower will turn
...
//               delay(5000);
    ...
    //Turn off left motor (right motor already off)

    pinMode(PinL_in1, LOW);
